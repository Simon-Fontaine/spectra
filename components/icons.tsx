...
interface IconsType {
  ...
  friends: LucideIcon;
  teams: LucideIcon;
  tournaments: LucideIcon;
  menu: (props: IconProps) => JSX.Element;
  logo: (props: LogoProps) => JSX.Element;
  twitter: (props: IconProps) => JSX.Element;
  discord: (props: IconProps) => JSX.Element;
  github: (props: IconProps) => JSX.Element;
  twitch: (props: IconProps) => JSX.Element;
}
...
export const Icons: IconsType = {
  ...
  // Logo component
  logo: ({ width, height, className, onClick }: LogoProps) => (
    <Image
      src="/images/icon.png"
      alt="Logo"
      width={width}
